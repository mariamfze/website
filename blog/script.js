let http=new XMLHttpRequest;const articleWrapper=document.getElementById("article-wrapper");async function getOneBlog(){let a=new URLSearchParams(window.location.search).get("id"),l=await fetch("../assets/json/data.json"),t=await l.json();displayArticle(t[a])}function displayArticle(a){articleWrapper.innerHTML=`
  <div class="blog-portal-main-card">
   ...
   <div class="main-article d-flex justify-content-center align-items-center flex-column">
     ...
     <img loading="lazy" class="article-main-img rounded-2 mb-2" src="../assets/blog-images/${a.landscape}" alt="">
...
`}http.open("get","../assets/json/data.json",!0),http.send(),http.onload=function(){if(4==this.readyState&&200==this.status){let a=JSON.parse(this.responseText),l="";for(let t of a)console.log(t.landscape),l+=`
      
     <div class="blog-portal-more-card">
     <a href="../blog/index.html?id=${t.id}">
     <img loading="lazy" class="blog-portal-more-img rounded-2 mb-2" src="../assets/blog-images/${t.landscape}" alt="">
     ...
     <div class="blog-portal-content">
      ...
      `;document.querySelector(".blog-portal-more").innerHTML=l}},getOneBlog();